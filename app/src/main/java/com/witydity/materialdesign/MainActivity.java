package com.witydity.materialdesign;
...
import com.witydity.materialdesign.adapter.ProductAdapter;
import com.witydity.materialdesign.adapter.ProductCategoryAdapter;
import com.witydity.materialdesign.model.ProductCategory;
import com.witydity.materialdesign.model.Products;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productCategoryList.add(new ProductCategory(1, "Computer"));
        productCategoryList.add(new ProductCategory(2, "Smart Mobile"));
        productCategoryList.add(new ProductCategory(3, "Watch"));
        productCategoryList.add(new ProductCategory(4, "Lotion"));
        productCategoryList.add(new ProductCategory(5, "Wear"));
        productCategoryList.add(new ProductCategory(6, "Samsung"));
        productCategoryList.add(new ProductCategory(7, "Redmi"));
